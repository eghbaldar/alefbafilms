...
namespace alefbafilm6.Persistence.Migrations
{
    ...
    [Migration("20230814204239_addContactTable")]
            ...
            modelBuilder.Entity("alefbafilms.domian.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            InsertTime = new DateTime(2023, 8, 15, 0, 12, 38, 877, DateTimeKind.Local).AddTicks(3570),
                            name = "Admin"
                        },
                        new
                        {
                            id = 2L,
                            InsertTime = new DateTime(2023, 8, 15, 0, 12, 38, 877, DateTimeKind.Local).AddTicks(3605),
                            name = "Operator"
                        },
                        new
                        {
                            id = 3L,
                            InsertTime = new DateTime(2023, 8, 15, 0, 12, 38, 877, DateTimeKind.Local).AddTicks(3615),
                            name = "User"
                        },
                        new
                        {
                            id = 4L,
                            InsertTime = new DateTime(2023, 8, 15, 0, 12, 38, 877, DateTimeKind.Local).AddTicks(3624),
                            name = "Guest"
                        });
                });
