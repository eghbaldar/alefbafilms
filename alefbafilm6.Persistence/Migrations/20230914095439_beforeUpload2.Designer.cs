...
namespace alefbafilm6.Persistence.Migrations
{
    ...
    [Migration("20230914095439_beforeUpload2")]
    partial class beforeUpload2
    {
            ...
            modelBuilder.Entity("alefbafilms.domian.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            InsertTime = new DateTime(2023, 9, 14, 13, 24, 38, 735, DateTimeKind.Local).AddTicks(7232),
                            name = "Admin"
                        },
                        new
                        {
                            id = 2L,
                            InsertTime = new DateTime(2023, 9, 14, 13, 24, 38, 735, DateTimeKind.Local).AddTicks(7271),
                            name = "Operator"
                        },
                        new
                        {
                            id = 3L,
                            InsertTime = new DateTime(2023, 9, 14, 13, 24, 38, 735, DateTimeKind.Local).AddTicks(7280),
                            name = "User"
                        },
                        new
                        {
                            id = 4L,
                            InsertTime = new DateTime(2023, 9, 14, 13, 24, 38, 735, DateTimeKind.Local).AddTicks(7289),
                            name = "Guest"
                        });
                });
