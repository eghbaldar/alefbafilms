...
namespace alefbafilm6.Persistence.Migrations
{
    ...
    [Migration("20230806223745_editGalleryClassesTest")]
    partial class editGalleryClassesTest
    {
            ...
            modelBuilder.Entity("alefbafilms.domian.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 7, 45, 397, DateTimeKind.Local).AddTicks(3626),
                            name = "Admin"
                        },
                        new
                        {
                            id = 2L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 7, 45, 397, DateTimeKind.Local).AddTicks(3660),
                            name = "Operator"
                        },
                        new
                        {
                            id = 3L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 7, 45, 397, DateTimeKind.Local).AddTicks(3671),
                            name = "User"
                        },
                        new
                        {
                            id = 4L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 7, 45, 397, DateTimeKind.Local).AddTicks(3681),
                            name = "Guest"
                        });
                });
