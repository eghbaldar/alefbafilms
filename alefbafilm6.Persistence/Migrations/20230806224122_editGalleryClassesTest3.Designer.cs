...
namespace alefbafilm6.Persistence.Migrations
{
    ...
    [Migration("20230806224122_editGalleryClassesTest3")]
    partial class editGalleryClassesTest3
    {
            ...
            modelBuilder.Entity("alefbafilms.domian.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 11, 22, 232, DateTimeKind.Local).AddTicks(5863),
                            name = "Admin"
                        },
                        new
                        {
                            id = 2L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 11, 22, 232, DateTimeKind.Local).AddTicks(5902),
                            name = "Operator"
                        },
                        new
                        {
                            id = 3L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 11, 22, 232, DateTimeKind.Local).AddTicks(5912),
                            name = "User"
                        },
                        new
                        {
                            id = 4L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 11, 22, 232, DateTimeKind.Local).AddTicks(5921),
                            name = "Guest"
                        });
                });
