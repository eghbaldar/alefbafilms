...
namespace alefbafilms.Persistence.Migrations
{
    ...
    [Migration("20230704220056_BaseEntity")]
            ...
            modelBuilder.Entity("alefbafilms.domian.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            InsertTime = new DateTime(2023, 7, 5, 1, 30, 56, 394, DateTimeKind.Local).AddTicks(8820),
                            name = "Admin"
                        },
                        new
                        {
                            id = 2L,
                            InsertTime = new DateTime(2023, 7, 5, 1, 30, 56, 394, DateTimeKind.Local).AddTicks(8857),
                            name = "Operator"
                        },
                        new
                        {
                            id = 3L,
                            InsertTime = new DateTime(2023, 7, 5, 1, 30, 56, 394, DateTimeKind.Local).AddTicks(8869),
                            name = "User"
                        },
                        new
                        {
                            id = 4L,
                            InsertTime = new DateTime(2023, 7, 5, 1, 30, 56, 394, DateTimeKind.Local).AddTicks(8877),
                            name = "Guest"
                        });
                });
