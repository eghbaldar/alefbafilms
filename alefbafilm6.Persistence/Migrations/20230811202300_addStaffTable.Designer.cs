...
namespace alefbafilm6.Persistence.Migrations
{
    ...
    [Migration("20230811202300_addStaffTable")]
            ...
            modelBuilder.Entity("alefbafilms.domian.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            InsertTime = new DateTime(2023, 8, 11, 23, 52, 59, 780, DateTimeKind.Local).AddTicks(3611),
                            name = "Admin"
                        },
                        new
                        {
                            id = 2L,
                            InsertTime = new DateTime(2023, 8, 11, 23, 52, 59, 780, DateTimeKind.Local).AddTicks(3647),
                            name = "Operator"
                        },
                        new
                        {
                            id = 3L,
                            InsertTime = new DateTime(2023, 8, 11, 23, 52, 59, 780, DateTimeKind.Local).AddTicks(3655),
                            name = "User"
                        },
                        new
                        {
                            id = 4L,
                            InsertTime = new DateTime(2023, 8, 11, 23, 52, 59, 780, DateTimeKind.Local).AddTicks(3662),
                            name = "Guest"
                        });
                });
