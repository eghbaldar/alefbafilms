...
namespace alefbafilm6.Persistence.Migrations
{
    ...
    [Migration("20230911083700_11-9-2023")]
    partial class _1192023
    {
            ...
            modelBuilder.Entity("alefbafilms.domian.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            InsertTime = new DateTime(2023, 9, 11, 12, 7, 0, 442, DateTimeKind.Local).AddTicks(4243),
                            name = "Admin"
                        },
                        new
                        {
                            id = 2L,
                            InsertTime = new DateTime(2023, 9, 11, 12, 7, 0, 442, DateTimeKind.Local).AddTicks(4278),
                            name = "Operator"
                        },
                        new
                        {
                            id = 3L,
                            InsertTime = new DateTime(2023, 9, 11, 12, 7, 0, 442, DateTimeKind.Local).AddTicks(4286),
                            name = "User"
                        },
                        new
                        {
                            id = 4L,
                            InsertTime = new DateTime(2023, 9, 11, 12, 7, 0, 442, DateTimeKind.Local).AddTicks(4293),
                            name = "Guest"
                        });
                });
