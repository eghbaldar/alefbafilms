...
namespace alefbafilm6.Persistence.Migrations
{
    ...
    [Migration("20230911084423_11-9-2023-2")]
    partial class _11920232
    {
            ...
            modelBuilder.Entity("alefbafilms.domian.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            InsertTime = new DateTime(2023, 9, 11, 12, 14, 22, 626, DateTimeKind.Local).AddTicks(9929),
                            name = "Admin"
                        },
                        new
                        {
                            id = 2L,
                            InsertTime = new DateTime(2023, 9, 11, 12, 14, 22, 626, DateTimeKind.Local).AddTicks(9960),
                            name = "Operator"
                        },
                        new
                        {
                            id = 3L,
                            InsertTime = new DateTime(2023, 9, 11, 12, 14, 22, 626, DateTimeKind.Local).AddTicks(9968),
                            name = "User"
                        },
                        new
                        {
                            id = 4L,
                            InsertTime = new DateTime(2023, 9, 11, 12, 14, 22, 626, DateTimeKind.Local).AddTicks(9976),
                            name = "Guest"
                        });
                });
