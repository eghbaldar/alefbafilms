...
namespace alefbafilm6.Persistence.Migrations
{
    ...
    [Migration("20230914095058_beforeUpload")]
    partial class beforeUpload
    {
            ...
            modelBuilder.Entity("alefbafilm6.Domain.Entities.Contact.Contact", b =>
                {
                    ...
                    b.ToTable("alefUsersEghbaldar", "dbo");
                });
            ...
            modelBuilder.Entity("alefbafilms.domian.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            InsertTime = new DateTime(2023, 9, 14, 13, 20, 58, 370, DateTimeKind.Local).AddTicks(2987),
                            name = "Admin"
                        },
                        new
                        {
                            id = 2L,
                            InsertTime = new DateTime(2023, 9, 14, 13, 20, 58, 370, DateTimeKind.Local).AddTicks(3022),
                            name = "Operator"
                        },
                        new
                        {
                            id = 3L,
                            InsertTime = new DateTime(2023, 9, 14, 13, 20, 58, 370, DateTimeKind.Local).AddTicks(3032),
                            name = "User"
                        },
                        new
                        {
                            id = 4L,
                            InsertTime = new DateTime(2023, 9, 14, 13, 20, 58, 370, DateTimeKind.Local).AddTicks(3040),
                            name = "Guest"
                        });
                });
