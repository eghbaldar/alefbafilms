...
namespace alefbafilm6.Persistence.Migrations
{
    ...
    [Migration("20230911084811_11-9-2023-3")]
    partial class _11920233
    {
            ...
            modelBuilder.Entity("alefbafilms.domian.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            InsertTime = new DateTime(2023, 9, 11, 12, 18, 11, 486, DateTimeKind.Local).AddTicks(371),
                            name = "Admin"
                        },
                        new
                        {
                            id = 2L,
                            InsertTime = new DateTime(2023, 9, 11, 12, 18, 11, 486, DateTimeKind.Local).AddTicks(399),
                            name = "Operator"
                        },
                        new
                        {
                            id = 3L,
                            InsertTime = new DateTime(2023, 9, 11, 12, 18, 11, 486, DateTimeKind.Local).AddTicks(408),
                            name = "User"
                        },
                        new
                        {
                            id = 4L,
                            InsertTime = new DateTime(2023, 9, 11, 12, 18, 11, 486, DateTimeKind.Local).AddTicks(415),
                            name = "Guest"
                        });
                });
