...
namespace alefbafilm6.Persistence.Migrations
{
    ...
    [Migration("20230806223832_editGalleryClassesTest2")]
    partial class editGalleryClassesTest2
    {
            ...
            modelBuilder.Entity("alefbafilms.domian.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 8, 31, 800, DateTimeKind.Local).AddTicks(9991),
                            name = "Admin"
                        },
                        new
                        {
                            id = 2L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 8, 31, 801, DateTimeKind.Local).AddTicks(45),
                            name = "Operator"
                        },
                        new
                        {
                            id = 3L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 8, 31, 801, DateTimeKind.Local).AddTicks(64),
                            name = "User"
                        },
                        new
                        {
                            id = 4L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 8, 31, 801, DateTimeKind.Local).AddTicks(81),
                            name = "Guest"
                        });
                });
