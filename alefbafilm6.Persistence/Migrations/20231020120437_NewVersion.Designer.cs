...
namespace alefbafilm6.Persistence.Migrations
{
    ...
    [Migration("20231020120437_NewVersion")]
            ...
            modelBuilder.Entity("alefbafilms.domian.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            InsertTime = new DateTime(2023, 10, 20, 15, 34, 37, 606, DateTimeKind.Local).AddTicks(7871),
                            name = "Admin"
                        },
                        new
                        {
                            id = 2L,
                            InsertTime = new DateTime(2023, 10, 20, 15, 34, 37, 606, DateTimeKind.Local).AddTicks(7901),
                            name = "Operator"
                        },
                        new
                        {
                            id = 3L,
                            InsertTime = new DateTime(2023, 10, 20, 15, 34, 37, 606, DateTimeKind.Local).AddTicks(7909),
                            name = "User"
                        },
                        new
                        {
                            id = 4L,
                            InsertTime = new DateTime(2023, 10, 20, 15, 34, 37, 606, DateTimeKind.Local).AddTicks(7916),
                            name = "Guest"
                        });
                });
