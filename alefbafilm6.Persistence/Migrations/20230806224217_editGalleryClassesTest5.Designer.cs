...
namespace alefbafilm6.Persistence.Migrations
{
    ...
    [Migration("20230806224217_editGalleryClassesTest5")]
    partial class editGalleryClassesTest5
    {
            ...
            modelBuilder.Entity("alefbafilms.domian.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 12, 16, 879, DateTimeKind.Local).AddTicks(326),
                            name = "Admin"
                        },
                        new
                        {
                            id = 2L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 12, 16, 879, DateTimeKind.Local).AddTicks(378),
                            name = "Operator"
                        },
                        new
                        {
                            id = 3L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 12, 16, 879, DateTimeKind.Local).AddTicks(393),
                            name = "User"
                        },
                        new
                        {
                            id = 4L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 12, 16, 879, DateTimeKind.Local).AddTicks(404),
                            name = "Guest"
                        });
                });
