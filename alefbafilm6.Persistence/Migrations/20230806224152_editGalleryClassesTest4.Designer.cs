...
namespace alefbafilm6.Persistence.Migrations
{
    ...
    [Migration("20230806224152_editGalleryClassesTest4")]
    partial class editGalleryClassesTest4
    {
            ...
            modelBuilder.Entity("alefbafilms.domian.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 11, 52, 259, DateTimeKind.Local).AddTicks(7288),
                            name = "Admin"
                        },
                        new
                        {
                            id = 2L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 11, 52, 259, DateTimeKind.Local).AddTicks(7333),
                            name = "Operator"
                        },
                        new
                        {
                            id = 3L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 11, 52, 259, DateTimeKind.Local).AddTicks(7344),
                            name = "User"
                        },
                        new
                        {
                            id = 4L,
                            InsertTime = new DateTime(2023, 8, 7, 2, 11, 52, 259, DateTimeKind.Local).AddTicks(7354),
                            name = "Guest"
                        });
                });
